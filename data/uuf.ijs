...
UUF=: cmx 0 : 0
LIBRARY FUNCTIONS:
exp(k*a) ; k(/),a(/)    [/]	exponential growth fn
exp(-k*a) ; k(/),a(/)   [/]	die-away fn
ln(a*b) ; a(/),b(/)     [/]	log-base-e of a*b
ln(a div b) ; a(/),b(/) [/]	log-base-e of a/b
((-b)+sqrt((b^2)-4*a*c)) div 2*a : a(/),b(/),c(/)	[/]	quadratic root[+]
((-b)-sqrt((b^2)-4*a*c)) div 2*a : a(/),b(/),c(/)	[/]	quadratic root[-]
...
M*W*W/3 : M(kg),W(m)		[kg m^2]	1st moment; rectangular plane; axis along edge
